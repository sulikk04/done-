                    ...
                    <div className="mentor-details">
                      ...
                      <div className="mentors-info">
                        <div className="info-item">
                          <span className="info-label">Провел уроков на платформе: </span>
                        ...
                        <div className="info-item">
                          <span className="info-price">500Р / в час</span>
                        </div>
                        <div className="mentors-tags">
                          <button className="tag-button">Таджвид</button>
                          <button className="tag-button">Махрадж</button>
                          <button className="tag-button">и еще 9...</button>
                        </div>
                      </div>
                    </div>
